              ...
              >
                {displayedPredictions.map((prediction, index) => (
                  <motion.div
                    ...
                    className={`border p-5 rounded-xl transition-colors relative overflow-hidden ${index < 10
                      ? 'border-blue-500/50 hover:border-blue-400'
                      : 'border-[#18181b] bg-zinc-900/10 hover:border-blue-400/50'
                      }`}
                  >
                    {index < 10 && (
                      <div className="absolute top-0 right-0 bg-gradient-to-l from-blue-600 to-blue-500 text-white text-[10px] font-extrabold px-3 py-1 rounded-bl-xl shadow-lg shadow-blue-500/20">
                        AI VERIFIED
                      </div>
                    )}
            ...
            >
              ...
              >
                <div className="flex justify-between items-start mb-6">
                  ...
                  <button onClick={closeDetails} className="cursor-pointer text-gray-400 hover:text-white p-2 text-2xl font-bold">&times;</button>
                </div>
                  ...
                  {selectedPrediction.details ? (
                    <>
                      ...
                      {selectedPrediction.details.reasoning && (
                        <div className="bg-gradient-to-br from-yellow-500/10 to-amber-500/5 border border-yellow-500/30 rounded-xl p-5 shadow-lg relative overflow-hidden">
                          <div className="absolute top-0 right-0 p-3 opacity-20">
                            <FaBullseye className="text-4xl text-yellow-500" />
                          </div>
                          <p className="text-yellow-500 text-xs font-black uppercase mb-2 tracking-wide flex items-center gap-2">
